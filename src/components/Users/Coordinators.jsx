    ...
    <div className='relative'>
      ...
      <div className='flex justify-between items-center mt-3'>
        ...
        <input className='p-2 outline-none ml-[-30px]' type="search" name="search" id="" placeholder='Search by name, role...' />
          ...
          <button className='bg-[#FFD7CE] text-[#FF5934] text-nowrap p-2 rounded' onClick={() => setFormVisible(true)}>+ Add Coordinator</button>
        </div>
      </div>
      <div className='mt-3'>
            ...
            {sales.map((data, index) => (
              <tr key={index} className='border-b cursor-pointer' onClick={() => setSelectedUser(data)}>
                <td className='flex items-center gap-2 p-2'>
                  <input type="checkbox" onClick={handleCheckboxClick} className='h-5 w-5 accent-black' />
